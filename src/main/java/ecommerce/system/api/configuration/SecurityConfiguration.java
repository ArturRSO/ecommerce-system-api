    ...
    public void configure(HttpSecurity http) {
        ...
        try {
            http.cors()
                    ...
                    .antMatchers("/stores/all").permitAll()
                    .antMatchers("/stores/user/**").hasAnyRole("system_admin", "store_admin")
                    .antMatchers("/stores/image/**").permitAll()
                    .antMatchers("/stores/update/**").hasAnyRole("system_admin", "store_admin")
                    .antMatchers("/stores/delete/**").hasAnyRole("store_admin")
                    .antMatchers("/products/sell").permitAll()
                    .antMatchers("/products/type/**").permitAll()
                    .antMatchers("/products/all").hasAnyRole("system_admin")
                    .antMatchers("/products/**").hasAnyRole("system_admin", "store_admin")
